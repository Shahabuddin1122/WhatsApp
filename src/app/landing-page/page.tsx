    ...
    return (
        <>
            <div className={"w-full h-[100px] bg-green-600 flex justify-center"}>
                <div className={"w-11/12 h-[710px] mt-5 bg-slate-100  "}>
                    <div className={"sm:w-1/2 md:w-2/5 lg:w-1/3 h-full bg-white shadow-xl  relative"}>
                        ...
                        <div className={"w-full h-[580px] relative overflow-y-scroll"}>
                            <div className={"w-full h-auto"}>
                                <div className="flex flex-col justify-center">
                                    ...
                                    <MessageCard text={"Hello"} number={"Nafees Kaiser"} time={"12:00 PM"}
                                                 image={avatarImage}/>
                                    <MessageCard text={"Hello"} number={"Nafees Kaiser"} time={"8:20 PM"}
                                                 image={avatarImage}/>
                                    <MessageCard text={"Hello"} number={"Nafees Kaiser"} time={"11:40 PM"}
                                                 image={avatarImage}/>
                                    <MessageCard text={"Hello"} number={"Nafees Kaiser"} time={"8:25 AM"}
                                                 image={avatarImage}/>
                                    <MessageCard text={"Hello"} number={"Nafees Kaiser"} time={"2:20 AM"}
                                                 image={avatarImage}/>
                                    <MessageCard text={"Hello"} number={"Nafees Kaiser"} time={"1:27 AM"}
                                                 image={avatarImage}/>
                                    <MessageCard text={"Hello"} number={"Nafees Kaiser"} time={"8:50 PM"}
                                                 image={avatarImage}/>
                                    <MessageCard text={"Hello"} number={"Nafees Kaiser"} time={"3:20 AM"}
                                                 image={avatarImage}/>
                                    <MessageCard text={"Hello"} number={"Nafees Kaiser"} time={"4:50 AM"}
                                                 image={avatarImage}/>
                        ...
                        <div
                            className={"w-full h-[55px] absolute bottom-0 border-t border-gray-300 bg-white flex justify-center items-center shadow-2xl"}>
